...
const createMainTweet = (): TweetView => {
...
const renderTweet = (tweetView: TweetView, view: HTMLDivElement, tweet: Tweet, last: boolean) => {
  ...
  countContainer.classList.add('countCountainer');
...
const updateTweet = (tweetView: TweetView, tweet: Tweet, value: Message) => {
